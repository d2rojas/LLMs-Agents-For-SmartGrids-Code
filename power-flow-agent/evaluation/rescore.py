#!/usr/bin/env python3
"""Offline re-scorer for ``evaluation/runner.py`` reports (no API key, no LLM).
...
Usage:
  .venv/bin/python evaluation/rescore.py evaluation/results_matrix_gpt-4o-mini/pfagent/case30 \
...
* ground truth: ``evaluation.runner.execute_intended(case, intended_calls,
  ...
  regenerated with ``evaluation.requests.generate_requests`` (verified against the
...
from evaluation import runner as ev  # noqa: E402
