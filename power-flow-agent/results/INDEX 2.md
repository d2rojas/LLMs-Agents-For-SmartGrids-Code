...
Generated 2026-09-23 11:14 by `run.py index`. One line per run directory, newest first. Counts are runs; Form. and Trace. are percentages. Open the folder for `REPORT.md`, `summary.csv` and `traces/`.
...
| 2026-09-16 | no-llm | rule_based | stress | v1 | 40 | 0 | 22 | 18 | 40.0 | 97.5 | 0 | 0.00 | stress table (S6) | [rule_based__stress__v1](ieee14/2026-09-16/no-llm/rule_based__stress__v1/REPORT.md) |
