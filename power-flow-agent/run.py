...
def cmd_run(args: argparse.Namespace) -> int:
    ...
    if not cases:  # no silent default: the design runs on four systems and every run names its own
        print("give --case: ieee14, ieee30, ieee57, ieee118 or ieee300 (repeatable)", file=sys.stderr)
        return 2
...
def build_parser() -> argparse.ArgumentParser:
    ...
    r.add_argument("--case", dest="cases", action="append", default=[], help="ieee14, ieee30, ieee57, ieee118, ieee300 (or case14 ...); repeatable; required")
