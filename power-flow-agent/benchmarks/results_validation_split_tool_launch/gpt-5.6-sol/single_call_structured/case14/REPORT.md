...
Generado el 2026-09-21 18:58 por benchmarks/experiment_report.py a partir de 1 report(s) del directorio case14 (ruta completa en la sección 1). Prosa en español; identificadores (métodos, métricas, campos) en inglés tal como aparecen en los datos.
...
````
/Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_split_tool_launch/gpt-5.6-sol/single_call_structured/case14
````
...
- Items totales: 40; ok=40; con error=0; tokens totales=197219
- Solved global: 12.5 % (5/40)
...
|---------------------------|------|----|-------------|---------------|---------|----------------|----------|-------------|---------------|------------------|---------|------|--------|-----|---------------|-----------------|----|
| single_call:structured | case14 | 40 | 20.0 (8/40) | 0 | 1.77e-03 | 0 | 0 | 12.5 (5/40) | 45.0 (18/40) | 42.5 | 95.0 | 4930 | 7.76 | -- | 45.0 (18/40) | 42.5 (17/40) | -- |
...
| Method | plain | parameterized | multistep | ambiguous |
|---------------------------|-------------|----------------|----------|----------|
| single_call:structured | 30.0 (3/10) | 20.0 (2/10) | 0.0 (0/10) | 0.0 (0/10) |
...
--- Ronda 2 [final] ---
LLM: The IEEE 14-bus case was loaded successfully, but no power-flow result was returned, so lines loaded above 80% cannot be identified.

**Key numbers**
- Total load: **259.035 MW**
- Total generation: **Not available** (only generation capacity of **772.4 MW** was returned)
- Total losses: **Not avail …[220 chars más]
--- Respuesta final ---
The IEEE 14-bus case was loaded successfully, but no power-flow result was returned, so lines loaded above 80% cannot be identified.
...
**Violations**
- Not evaluated because the power flow was not run.

**Suggested next step**
- Run the AC power flow, then query branch loadings to list every line above **80%**.
--- Scoring ---
formulation=ok (exact=True); V_MAE=0; F_MAE=0.00; faithful=100.0 %; solved=True (numeric_and_answer_ok); flags=-; error=-; tokens=4948; cost_usd=--; wall=10.6 s
````
...
tool: load_case({"case_name": "case14"})
  ...
  gate: n/a (no es un resultado de flujo)
--- Ronda 2 [final] ---
LLM: 1. **Summary:** case14 was loaded successfully, but the requested bus 10–11 line disconnection was not executed.

2. **Key numbers:** 14 buses, 5 generators, 20 branches, 11 loads; total load **253.84578240591338 MW**; generation capacity **772.4000000000001 MW**. Power-flow generation, losses, and …[221 chars más]
--- Respuesta final ---
1. **Summary:** case14 was loaded successfully, but the requested bus 10–11 line disconnection was not executed.

2. **Key numbers:** 14 buses, 5 generators, 20 branches, 11 loads; total load **253.84578240591338 MW**; generation capacity **772.4000000000001 MW**. Power-flow generation, losses, and voltage range were not returned.

3. **Violations:** Not evaluated because no post-disconnection power flow was run.

4. **Suggested next step:** Disconnect the branch between buses 10 and 11 and recompute the power flow.
--- Scoring ---
formulation=missed_step (exact=False); V_MAE=2.05e-03; F_MAE=1.39; faithful=100.0 %; solved=False (formulation); flags=-; error=-; tokens=4890; cost_usd=--; wall=6.9 s
````
...
tool: load_case({"case_name": "case14"})
  ...
  gate: n/a (no es un resultado de flujo)
--- Ronda 2 [final] ---
LLM: 1. **Summary:** The case14 network was loaded successfully, but the requested 6–13 line disconnection was not performed because no disconnection tool result is available.
2. **Key numbers:** 14 buses, 5 generators, 20 branches, 11 loads; total load **261.9028323717408 MW**; generation capacity **772 …[220 chars más]
--- Respuesta final ---
1. **Summary:** The case14 network was loaded successfully, but the requested 6–13 line disconnection was not performed because no disconnection tool result is available.
2. **Key numbers:** 14 buses, 5 generators, 20 branches, 11 loads; total load **261.9028323717408 MW**; generation capacity **772.4000000000001 MW**. Total generation, losses, and voltage range were not reported.
3. **Violations:** Not evaluated.
4. **Suggested next step:** Disconnect the branch between buses 6 and 13 and recompute the power flow.
--- Scoring ---
formulation=missed_step (exact=False); V_MAE=8.99e-03; F_MAE=3.80; faithful=100.0 %; solved=False (formulation); flags=-; error=-; tokens=4899; cost_usd=--; wall=7.6 s
````
...
- Solved de `single_call:structured`: 12.5 % (5/40).
...
- Trazabilidad de números (Faith.) media con tools: 98.7 %.
...
````
report: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_split_tool_launch/gpt-5.6-sol/single_call_structured/case14/report.json   [leído: report.rescored.json]
  scoreboard.json: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_split_tool_launch/gpt-5.6-sol/single_call_structured/case14/scoreboard.json
  scoreboard.csv: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_split_tool_launch/gpt-5.6-sol/single_call_structured/case14/scoreboard.csv
  scoreboard.md: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_split_tool_launch/gpt-5.6-sol/single_call_structured/case14/scoreboard.md
  scoreboard_per_case.json: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_split_tool_launch/gpt-5.6-sol/single_call_structured/case14/scoreboard_per_case.json
  scoreboard.rescored.json: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_split_tool_launch/gpt-5.6-sol/single_call_structured/case14/scoreboard.rescored.json
  scoreboard_per_case.rescored.json: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_split_tool_launch/gpt-5.6-sol/single_call_structured/case14/scoreboard_per_case.rescored.json
  traces (40 archivos): /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_split_tool_launch/gpt-5.6-sol/single_call_structured/case14/traces
````
