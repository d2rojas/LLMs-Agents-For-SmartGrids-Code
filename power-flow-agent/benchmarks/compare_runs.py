...
"""Request-by-request comparison of two run directories (same requests, e.g. before and after a prompt change).
    ...
    .venv/bin/python benchmarks/compare_runs.py <before_dir> <after_dir> [--out COMPARE.md] [--label-a 21-09] [--label-b matched]
...
from benchmarks.postprocess import _fmt_call, _outcome, load_report, select_rows  # noqa: E402
