...
"""
    ...
    H.append("<div class='card'><h2>Three pages, three stages</h2><div class='flow'><div class='box' style='border-color:var(--acc)'><b>1 · Design</b><span>this page: methods, prompts, answer object, evaluator, run plan. Written before any run, so it carries no numbers and no verdicts.</span></div><span class='arr'>→</span><div class='box'><b>2 · Results</b><span><a href='results.html'>results.html</a> and <a href='viewer.html'>viewer.html</a>: the numbers and every trace, exactly as the runs produced them. Filled after the runs.</span></div><span class='arr'>→</span><div class='box'><b>3 · Analysis</b><span>analysis.html: comparisons, failure catalogue and conclusions, written only from the results page. Last.</span></div></div><p class='muted'>Keeping the stages apart is deliberate: the design is approved before the money is spent, the results are recorded before anyone interprets them, and the conclusions cite the results rather than expectations.</p></div>")
