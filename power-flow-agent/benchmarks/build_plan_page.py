...
"""
    ...
    H.append("<div class='card'><h2>One question, six ways to answer it</h2><p>Every method receives the same 40 natural-language power-flow requests on the same perturbed IEEE 14-bus network and is scored the same way. What changes between methods is only <b>who formulates</b> the solver operations, <b>who computes</b> the numbers, whether the method <b>sees the solver's outputs</b> before answering, and whether a <b>gate</b> checks the answer before it is reported.</p>")
