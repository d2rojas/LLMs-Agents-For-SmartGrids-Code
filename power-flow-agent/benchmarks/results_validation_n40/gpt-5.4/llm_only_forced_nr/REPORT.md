...
Generado el 2026-09-16 13:58 por benchmarks/experiment_report.py a partir de 1 report(s) del directorio llm_only_forced_nr (ruta completa en la sección 1). Prosa en español; identificadores (métodos, métricas, campos) en inglés tal como aparecen en los datos.
...
|----------------------|------|----|-----|--------|-----|---------------|----------------|--------|------|----|-----|----|-----|----------|----------|------|
| llm_only_forced:nr | case14 | 40 | -- | 5.93e-03 | 4.76 | 65.0 (26/40) | 100.0 (40/40) | 5.54e+00 | 1.7 | -- | n/a | 3440 | -- | 0.0 (0/40) | 0.0 (0/40) | 0.8601 |
