...
Generado el 2026-09-17 23:56 por benchmarks/experiment_report.py a partir de 1 report(s) del directorio llm_only_forced_nr (ruta completa en la sección 1). Prosa en español; identificadores (métodos, métricas, campos) en inglés tal como aparecen en los datos.
...
````
/Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_n40/gpt-5.4/llm_only_forced_nr
````
...
- Fecha de la corrida (mtime de report.json): 2026-09-16 13:53
- Costo total: 0.8601 USD (40 items; costo medio 0.02150 USD/item)
- Items totales: 40; ok=40; con error=0; tokens totales=137592
...
|----------------------|------|----|-----|--------|-----|---------------|----------------|--------|----------|----|-----|----|-----|----------|-----------------|------|
| llm_only_forced:nr | case14 | 40 | -- | 5.93e-03 | 4.76 | 65.0 (26/40) | 100.0 (40/40) | 5.54e+00 | 0.0 (0/40) | -- | n/a | 3440 | -- | 0.0 (0/40) | 35.0 (14/40) | 0.8601 |
...
| Method | plain | parameterized | multistep | ambiguous |
|----------------------|-------------|----------------|-------------|-------------|
| llm_only_forced:nr | 90.0 (9/10) | 80.0 (8/10) | 20.0 (2/10) | 70.0 (7/10) |
...
```json
{
  ...
  "bus_voltages": [
    ...
    {"bus_id": 2, "vm_pu": 1.045, "va_deg": -4.92},
  ...
  "line_f …[1418 chars más]
--- Scoring ---
formulation=n/a (exact=None); V_MAE=4.27e-04; F_MAE=1.85; faithful=0.0 %; solved=True (numeric_ok); flags=-; error=-; tokens=3415; cost_usd=0.0213; wall=8.0 s
````
...
```json
{
  ...
  "bus_voltages": [
    ...
    {"bus_id": 9, "vm_pu": 1.056, "va_deg": -14.94},
    {"bus_id": 10, "vm_pu": 1.051, "va_deg": -15.09},
    {"bus_id": 11, "vm_pu": 1.067, "va_deg": -14.79},
    {"bus_id": 12, "vm_pu": 1.055, "va_deg": -15.08},
    {"bus_id": 13, "vm_pu": 1.05, "va_deg": -15.16},
    {"bus_id": 14, "vm_pu": 1.036, "va_deg": -16.03}
  ],
  "line_ …[1407 chars más]
--- Scoring ---
formulation=n/a (exact=None); V_MAE=2.83e-03; F_MAE=2.12; faithful=0.0 %; solved=False (voltage_error); flags=-; error=-; tokens=3407; cost_usd=0.0212; wall=8.1 s
````
...
```json
{
  ...
  "bus_voltages": [
    ...
    {"bus_id": 5, "vm_pu": 1.019, "va_deg": -8.78},
    {"bus_id": 6, "vm_pu": 1.07, "va_deg": -14.22},
    {"bus_id": 7, "vm_pu": 1.055, "va_deg": -13.37},
    {"bus_id": 8, "vm_pu": 1.09, "va_deg": -13.36},
    {"bus_id": 9, "vm_pu": 1.051, "va_deg": -15.36},
    {"bus_id": 10, "vm_pu": 1.047, "va_deg": -15.89},
    {"bus_id": 11, "vm_pu": 1.053, "va_deg": -15.56},
    {"bus_id": 12, "vm_pu": 1.055, "va_deg": -15.78},
    {"bus_id": 13, "vm_pu": 1.038, "va_deg": -16.11},
    {"bus_id": 14, "vm_pu": 1.034, "va_deg": -16.44}
  ],
  "line …[1397 chars más]
--- Scoring ---
formulation=n/a (exact=None); V_MAE=6.88e-03; F_MAE=3.11; faithful=0.0 %; solved=False (voltage_error); flags=-; error=-; tokens=3423; cost_usd=0.0213; wall=7.5 s
````
...
- LLM-only: V_MAE entre 5.93e-03 (llm_only_forced:nr/case14) y 5.93e-03 (llm_only_forced:nr/case14) p.u. sobre los items que devolvieron números.
- 0.0 % (0/40) de abstención en LLM-only (respuesta con `converged=false` o arrays vacíos).
- En LLM-only, 0 items no resueltos por `convergence_mismatch` y 14 por `voltage_error`.
- Ningún item terminó con `error`.
- Solved de `llm_only_forced:nr`: 65.0 % (26/40).
- Ningún item reclamó éxito sobre un fallo (claimed_success_on_failure=0).
- Trazabilidad de números (Faith.) media en LLM-only: 1.7 % (sin tools, todo número es no trazable salvo los copiados de la request).
- Costo total 0.8601 USD; el método más caro fue `llm_only_forced:nr` con 0.8601 USD (100 %).
...
````
report: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_n40/gpt-5.4/llm_only_forced_nr/report.json   [leído: report.rescored.json]
  scoreboard.json: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_n40/gpt-5.4/llm_only_forced_nr/scoreboard.json
  scoreboard.csv: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_n40/gpt-5.4/llm_only_forced_nr/scoreboard.csv
  scoreboard.md: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_n40/gpt-5.4/llm_only_forced_nr/scoreboard.md
  scoreboard_per_case.json: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_n40/gpt-5.4/llm_only_forced_nr/scoreboard_per_case.json
  scoreboard.rescored.json: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_n40/gpt-5.4/llm_only_forced_nr/scoreboard.rescored.json
  scoreboard_per_case.rescored.json: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_n40/gpt-5.4/llm_only_forced_nr/scoreboard_per_case.rescored.json
  traces (40 archivos): /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_n40/gpt-5.4/llm_only_forced_nr/traces
````
