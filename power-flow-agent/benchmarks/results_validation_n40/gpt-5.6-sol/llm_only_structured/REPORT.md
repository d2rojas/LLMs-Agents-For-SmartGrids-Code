...
Generado el 2026-09-18 21:57 por benchmarks/experiment_report.py a partir de 1 report(s) del directorio llm_only_structured (ruta completa en la sección 1). Prosa en español; identificadores (métodos, métricas, campos) en inglés tal como aparecen en los datos.
...
````
/Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_n40/gpt-5.6-sol/llm_only_structured
````
...
- Fecha de la corrida (mtime de report.json): 2026-09-18 00:26
- Costo total: 3.4714 USD (40 items; costo medio 0.08678 USD/item)
- Items totales: 40; ok=38; con error=2; tokens totales=410832
...
|----------------------------------------|-----|----------------------------|
| ValueError: no_json_object_found | 2 | llm_only:structured (2) |
...
|-----------------------|------|----|-----|--------|-----|---------------|----------------|--------|----------|----|-----|-----|-----|---------|-----------------|------|
| llm_only:structured | case14 | 40 | -- | 1.70e-03 | 1.42 | 52.5 (21/40) | 92.1 (35/38) | 3.78e-01 | 5.0 (2/40) | -- | n/a | 10271 | -- | -- | -- | 3.4714 |
...
| Method | plain | parameterized | multistep | ambiguous |
|-----------------------|-------------|----------------|-------------|-------------|
| llm_only:structured | 70.0 (7/10) | 40.0 (4/10) | 40.0 (4/10) | 60.0 (6/10) |

### Tipos de error de formulación (conteo de items)

| Method | unparsed |
|-----------------------|--------|
| llm_only:structured | 2 |

### Errores de ejecución por método (conteo de items con `error`)

| Method | ValueError: no_json_object_found |
|-----------------------|----------------------------------------|
| llm_only:structured | 2 |
...
--- Respuesta final ---
{"converged":true,"bus_voltages":[{"bus_id":1,"vm_pu":1.06,"va_deg":0.0},{"bus_id":2,"vm_pu":1.045,"va_deg":-4.91},{"bus_id":3,"vm_pu":1.01,"va_deg":-12.53},{"bus_id":4,"vm_pu":1.0165,"va_deg":-10.42},{"bus_id":5,"vm_pu":1.0186,"va_deg":-8.91},{"bus_id":6,"vm_pu":1.07,"va_deg":-14.19},{"bus_id":7,"vm_pu":1.0595,"va_deg":-13.72},{"bus_id":8,"vm_pu":1.09,"va_deg":-13.72},{"bus_id":9,"vm_pu":1.0508,"va_deg":-15.53},{"bus_id":10,"vm_pu":1.0446,"va_deg":-15.91},{"bus_id":11,"vm_pu":1.063,"va_deg":-14.32},{"bus_id":12,"vm_pu":1.054,"va_deg":-15.13},{"bus_id":13,"vm_pu":1.048,"va_deg":-15.37},{"bus_id":14,"vm_pu":1.031,"va_deg":-16.53}],"line_flows":[{"line_id":0,"p_from_mw":151.5,"loading_percent":0.0},{"line_id":1,"p_from_mw":74.4,"loading_percent":0.0},{"line_id":2,"p_from_mw":69.5,"loading_pe …[1031 chars más]
--- Scoring ---
formulation=n/a (exact=None); V_MAE=9.94e-04; F_MAE=0.32; faithful=0.0 %; solved=True (numeric_ok); flags=-; error=-; tokens=10836; cost_usd=0.0923; wall=173.1 s
````
...
(sin rondas de herramientas: una sola llamada al LLM)
--- Respuesta final ---
{"converged":true,"bus_voltages":[{"bus_id":1,"vm_pu":1.06,"va_deg":0.0},{"bus_id":2,"vm_pu":1.045,"va_deg":-5.05},{"bus_id":3,"vm_pu":1.01,"va_deg":-12.94},{"bus_id":4,"vm_pu":1.013,"va_deg":-10.47},{"bus_id":5,"vm_pu":1.018,"va_deg":-8.89},{"bus_id":6,"vm_pu":1.07,"va_deg":-14.02},{"bus_id":7,"vm_pu":1.059,"va_deg":-13.75},{"bus_id":8,"vm_pu":1.09,"va_deg":-13.75},{"bus_id":9,"vm_pu":1.049,"va_deg":-15.43},{"bus_id":10,"vm_pu":1.045,"va_deg":-15.47},{"bus_id":11,"vm_pu":1.053,"va_deg":-15.07},{"bus_id":12,"vm_pu":1.046,"va_deg":-16.28},{"bus_id":13,"vm_pu":1.025,"va_deg":-17.62},{"bus_id":14,"vm_pu":1.022,"va_deg":-17.31}],"line_flows":[{"line_id":0,"p_from_mw":159.8,"loading_percent":0.0},{"line_id":1,"p_from_mw":77.196895,"loading_percent":0.0},{"line_id":2,"p_from_mw":74.8,"loading_pe …[1026 chars más]
--- Scoring ---
formulation=n/a (exact=None); V_MAE=4.30e-03; F_MAE=0.56; faithful=0.0 %; solved=False (voltage_error); flags=-; error=-; tokens=13669; cost_usd=0.1206; wall=225.7 s
````
...
(sin rondas de herramientas: una sola llamada al LLM)
--- Respuesta final ---
{"converged":true,"bus_voltages":[{"bus_id":1,"vm_pu":1.06,"va_deg":0.0},{"bus_id":2,"vm_pu":1.045,"va_deg":-5.237},{"bus_id":3,"vm_pu":1.01,"va_deg":-13.399},{"bus_id":4,"vm_pu":1.0169,"va_deg":-10.782},{"bus_id":5,"vm_pu":1.0192,"va_deg":-9.206},{"bus_id":6,"vm_pu":1.07,"va_deg":-15.118},{"bus_id":7,"vm_pu":1.0604,"va_deg":-13.907},{"bus_id":8,"vm_pu":1.09,"va_deg":-13.907},{"bus_id":9,"vm_pu":1.0558,"va_deg":-15.524},{"bus_id":10,"vm_pu":1.051,"va_deg":-15.711},{"bus_id":11,"vm_pu":1.0565,"va_deg":-15.55},{"bus_id":12,"vm_pu":1.0549,"va_deg":-16.019},{"bus_id":13,"vm_pu":1.0498,"va_deg":-16.094},{"bus_id":14,"vm_pu":1.0349,"va_deg":-16.809}],"line_flows":[{"line_id":0,"p_from_mw":164.423,"loading_percent":0.0},{"line_id":1,"p_from_mw":78.93935,"loading_percent":0.0},{"line_id":2,"p_from …[1086 chars más]
--- Scoring ---
formulation=n/a (exact=None); V_MAE=5.61e-04; F_MAE=0.08; faithful=0.0 %; solved=True (numeric_ok); flags=-; error=-; tokens=10881; cost_usd=0.0927; wall=144.8 s
````
...
- LLM-only: V_MAE entre 1.70e-03 (llm_only:structured/case14) y 1.70e-03 (llm_only:structured/case14) p.u. sobre los items que devolvieron números.
- 0.0 % (0/40) de abstención en LLM-only (respuesta con `converged=false` o arrays vacíos).
- En LLM-only, 3 items no resueltos por `convergence_mismatch` y 14 por `voltage_error`.
- 2 items con error `ValueError: no_json_object_found`.
...
- Costo total 3.4714 USD; el método más caro fue `llm_only:structured` con 3.4714 USD (100 %).
...
````
report: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_n40/gpt-5.6-sol/llm_only_structured/report.json
  scoreboard.json: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_n40/gpt-5.6-sol/llm_only_structured/scoreboard.json
  scoreboard.csv: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_n40/gpt-5.6-sol/llm_only_structured/scoreboard.csv
  scoreboard.md: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_n40/gpt-5.6-sol/llm_only_structured/scoreboard.md
  scoreboard_per_case.json: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_n40/gpt-5.6-sol/llm_only_structured/scoreboard_per_case.json
  traces (40 archivos): /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_n40/gpt-5.6-sol/llm_only_structured/traces
````
