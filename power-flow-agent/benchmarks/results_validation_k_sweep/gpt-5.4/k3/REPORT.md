# Informe de experimento: `k3`

Generado el 2026-09-16 13:16 por benchmarks/experiment_report.py a partir de 1 report(s) del directorio k3 (ruta completa en la sección 1). Prosa en español; identificadores (métodos, métricas, campos) en inglés tal como aparecen en los datos.
...
````
/Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_k_sweep/gpt-5.4/k3
````
...
- Fecha de la corrida (mtime de report.json): 2026-09-16 13:13
- Costo total: 0.0834 USD (5 items; costo medio 0.01668 USD/item)
- Items totales: 5; ok=5; con error=0; tokens totales=14068
...
**User prompt (primer item)** — 5127 caracteres; case=case14, seed=1911784258, k=3, request_id=case14-ambiguous-003-s0
...
0     2  21.021395  12.302844        True
1     3  68.780106  13.872845        True
2     4  41.104379  -3.353705        True
3     5   5.461965   1.149887        True
4     6  12.821491   8.585820        True
5     9  37.687806  21.207375        True
6    10  11.143740   7.181521        True
7    11   3.272759   1.683133        True
8    12   7.418970   1.945959        True
9    13  17.272830   7.420919        True
10   14  17.551906   5.889901        True

### Generator Data (Generator Table: net.gen)

   bus      p_mw  vm_pu  min_p_mw  max_p_mw  min_q_mvar  max_q_mvar  in_service
0    2  44.89969  1.045       0.0     140.0       -40.0        50.0        True
...
|--------------------------------|------|----|-----|--------|-----|---------|----------------|--------|------|----|-----|----|-----|---------|---------|------|
| llm_only_forced:structured | case14 | 5 | -- | 5.90e-03 | 6.54 | 0.0 (0/5) | 100.0 (5/5) | 1.03e+01 | 0.0 | -- | n/a | 2814 | -- | 0.0 (0/5) | 0.0 (0/5) | 0.0834 |
...
--- Respuesta final ---
{"converged":true,"bus_voltages":[{"bus_id":1,"vm_pu":1.06,"va_deg":0.0},{"bus_id":2,"vm_pu":1.045,"va_deg":-5.12},{"bus_id":3,"vm_pu":1.01,"va_deg":-12.31},{"bus_id":4,"vm_pu":1.019,"va_deg":-10.23},{"bus_id":5,"vm_pu":1.02,"va_deg":-8.77},{"bus_id":6,"vm_pu":1.07,"va_deg":-14.36},{"bus_id":7,"vm_pu":1.058,"va_deg":-13.94},{"bus_id":8,"vm_pu":1.09,"va_deg":-13.94},{"bus_id":9,"vm_pu":1.044,"va_deg":-15.72},{"bus_id":10,"vm_pu":1.032,"va_deg":-16.98},{"bus_id":11,"vm_pu":1.055,"va_deg":-14.36},{"bus_id":12,"vm_pu":1.055,"va_deg":-15.06},{"bus_id":13,"vm_pu":1.05,"va_deg":-15.16},{"bus_id":14,"vm_pu":1.036,"va_deg":-16.04}],"line_flows":[{"line_id":0,"p_from_mw":156.88,"loading_percent":0.0},{"line_id":1,"p_from_mw":75.52,"loading_percent":0.0},{"line_id":2,"p_from_mw":73.24,"loading_percen …[1025 chars más]
--- Scoring ---
formulation=n/a (exact=None); V_MAE=4.09e-03; F_MAE=5.80; faithful=0.0 %; solved=False (voltage_error); flags=-; error=-; tokens=2801; cost_usd=0.0167; wall=6.8 s
````
...
(sin rondas de herramientas: una sola llamada al LLM)
--- Respuesta final ---
{"converged":true,"bus_voltages":[{"bus_id":1,"vm_pu":1.06,"va_deg":0.0},{"bus_id":2,"vm_pu":1.045,"va_deg":-4.98},{"bus_id":3,"vm_pu":1.01,"va_deg":-12.72},{"bus_id":4,"vm_pu":1.017,"va_deg":-10.33},{"bus_id":5,"vm_pu":1.019,"va_deg":-8.78},{"bus_id":6,"vm_pu":1.07,"va_deg":-14.22},{"bus_id":7,"vm_pu":1.062,"va_deg":-13.37},{"bus_id":8,"vm_pu":1.09,"va_deg":-13.36},{"bus_id":9,"vm_pu":1.056,"va_deg":-14.94},{"bus_id":10,"vm_pu":1.051,"va_deg":-15.1},{"bus_id":11,"vm_pu":1.056,"va_deg":-14.79},{"bus_id":12,"vm_pu":1.055,"va_deg":-15.08},{"bus_id":13,"vm_pu":1.05,"va_deg":-15.16},{"bus_id":14,"vm_pu":1.036,"va_deg":-16.04}],"line_flows":[{"line_id":0,"p_from_mw":156.88,"loading_percent":0.0},{"line_id":1,"p_from_mw":75.51,"loading_percent":0.0},{"line_id":2,"p_from_mw":73.24,"loading_percen …[1021 chars más]
--- Scoring ---
formulation=n/a (exact=None); V_MAE=1.99e-02; F_MAE=5.99; faithful=0.0 %; solved=False (voltage_error); flags=-; error=-; tokens=2842; cost_usd=0.0168; wall=7.1 s
````
...
- LLM-only: V_MAE entre 5.90e-03 (llm_only_forced:structured/case14) y 5.90e-03 (llm_only_forced:structured/case14) p.u. sobre los items que devolvieron números.
...
- Costo total 0.0834 USD; el método más caro fue `llm_only_forced:structured` con 0.0834 USD (100 %).

## 6. Archivos

Rutas absolutas bajo `k3`. `report.rescored.json` (cuando existe) es el archivo leído para las métricas.

````
report: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_k_sweep/gpt-5.4/k3/report.json   [leído: report.rescored.json]
  scoreboard.json: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_k_sweep/gpt-5.4/k3/scoreboard.json
  scoreboard.csv: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_k_sweep/gpt-5.4/k3/scoreboard.csv
  scoreboard.md: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_k_sweep/gpt-5.4/k3/scoreboard.md
  scoreboard_per_case.json: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_k_sweep/gpt-5.4/k3/scoreboard_per_case.json
  scoreboard.rescored.json: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_k_sweep/gpt-5.4/k3/scoreboard.rescored.json
  scoreboard_per_case.rescored.json: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_k_sweep/gpt-5.4/k3/scoreboard_per_case.rescored.json
  traces (5 archivos): /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_k_sweep/gpt-5.4/k3/traces
````
