...
Generado el 2026-09-21 13:19 por benchmarks/experiment_report.py a partir de 1 report(s) del directorio pfagent (ruta completa en la sección 1). Prosa en español; identificadores (métodos, métricas, campos) en inglés tal como aparecen en los datos.
...
````
/Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_load_split/gpt-4o-mini/pfagent
````
...
- Fecha de la corrida (mtime de report.json): 2026-09-18 22:06
- Costo total: 0.0554 USD (40 items; costo medio 0.00138 USD/item)
- Items totales: 40; ok=40; con error=0; tokens totales=342603
- Solved global: 67.5 % (27/40)
...
|-------|------|----|---------------|---------------|---------|----------------|----------|---------------|-------------|------------------|---------|------|--------|-----|----------|-----------------|------|
| pfagent | case14 | 40 | 97.5 (39/40) | 0 | 1.90e-07 | 0 | 0 | 67.5 (27/40) | 32.5 (2/40) | 0.0 | 100.0 | 8565 | 6.99 | -- | 5.0 (2/40) | 27.5 (11/40) | 0.0554 |
...
| Method | plain | parameterized | multistep | ambiguous |
|-------|-------------|----------------|-------------|-------------|
| pfagent | 80.0 (8/10) | 80.0 (8/10) | 20.0 (2/10) | 90.0 (9/10) |
...
|-------|----|---------------|----------|----------|-----------------|
| pfagent | 40 | 95.0 (38/40) | 0.0 (0/40) | 5.0 (2/40) | 0.0 (0/40) |
...
**Violations:**
- Overvoltage violations at buses 1, 6, 7, 8, 11, …[145 chars más]
--- Respuesta final ---
...
--- Scoring ---
formulation=ok (exact=True); V_MAE=0; F_MAE=0.00; faithful=100.0 %; solved=True (numeric_and_answer_ok); flags=-; error=-; tokens=4693; cost_usd=0.0008; wall=9.5 s
````
...
executed_calls: load_case({"case_name": "case14"}) -> set_active_load({"bus_id": 1, "p_mw": 11})
fuente de la traza: archivo de traza completo
--- Ronda 1 ---
tool: load_case({"case_name": "case14"})
...
--- Scoring ---
formulation=wrong_id (exact=False); V_MAE=7.59e-06; F_MAE=0.61; faithful=100.0 %; solved=False (formulation); flags=-; error=-; tokens=4897; cost_usd=0.0008; wall=7.2 s
````
...
2. Key numbers: 
   ...
   - Voltage Range: 0.918 to 1.090 …[309 chars más]
--- Respuesta final ---
...
4. Suggested next step: Consider running a contingency analysis to assess the impact of potential line outages or recommend remedial actions to address the voltage violations.
--- Scoring ---
formulation=ok (exact=True); V_MAE=0; F_MAE=0.00; faithful=100.0 %; solved=False (answer_mismatch); flags=-; error=-; tokens=7252; cost_usd=0.0012; wall=5.1 s
````
...
- Costo total 0.0554 USD; el método más caro fue `pfagent` con 0.0554 USD (100 %).
- Métodos con tools: 2.38 tool calls medias por item (máximo 6).
...
````
report: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_load_split/gpt-4o-mini/pfagent/report.json   [leído: report.rescored.json]
  scoreboard.json: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_load_split/gpt-4o-mini/pfagent/scoreboard.json
  scoreboard.csv: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_load_split/gpt-4o-mini/pfagent/scoreboard.csv
  scoreboard.md: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_load_split/gpt-4o-mini/pfagent/scoreboard.md
  scoreboard_per_case.json: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_load_split/gpt-4o-mini/pfagent/scoreboard_per_case.json
  scoreboard.rescored.json: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_load_split/gpt-4o-mini/pfagent/scoreboard.rescored.json
  scoreboard_per_case.rescored.json: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_load_split/gpt-4o-mini/pfagent/scoreboard_per_case.rescored.json
  traces (40 archivos): /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_load_split/gpt-4o-mini/pfagent/traces
````
