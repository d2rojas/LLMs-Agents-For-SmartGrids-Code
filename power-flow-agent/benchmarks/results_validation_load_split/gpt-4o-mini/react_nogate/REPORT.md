...
Generado el 2026-09-18 22:46 por benchmarks/experiment_report.py a partir de 1 report(s) del directorio react_nogate (ruta completa en la sección 1). Prosa en español; identificadores (métodos, métricas, campos) en inglés tal como aparecen en los datos.
...
````
/Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_load_split/gpt-4o-mini/react_nogate
````
...
- Fecha de la corrida (mtime de report.json): 2026-09-18 22:01
- Costo total: 0.0514 USD (40 items; costo medio 0.00128 USD/item)
- Items totales: 40; ok=40; con error=0; tokens totales=317414
...
|---------------|------|----|---------------|-----|-----|---------------|----------------|------|---------------|----|-----|----|-----|----------|-----------------|------|
| react_nogate | case14 | 40 | 97.5 (39/40) | 0 | 0.02 | 97.5 (39/40) | 100.0 (40/40) | 0 | 92.5 (37/40) | -- | 2.3 | 7935 | -- | 0.0 (0/40) | 2.5 (1/40) | 0.0514 |
...
**Violations:**
- Overvoltage violations at buses 1, 6, 7, 8, 11, …[147 chars más]
--- Respuesta final ---
...
--- Scoring ---
formulation=ok (exact=True); V_MAE=0; F_MAE=0.00; faithful=100.0 %; solved=True (numeric_ok); flags=-; error=-; tokens=4692; cost_usd=0.0008; wall=12.2 s
````
...
--- Scoring ---
formulation=wrong_id (exact=False); V_MAE=7.59e-06; F_MAE=0.61; faithful=100.0 %; solved=False (formulation); flags=-; error=-; tokens=4897; cost_usd=0.0008; wall=4.9 s
````
...
**Violations:**
- Overvoltage at buses 1, 6, 7, 8, and 1 …[139 chars más]
--- Respuesta final ---
...
--- Scoring ---
formulation=ok (exact=True); V_MAE=0; F_MAE=0.00; faithful=100.0 %; solved=True (numeric_ok); flags=-; error=-; tokens=4655; cost_usd=0.0008; wall=16.1 s
````
...
- Trazabilidad de números (Faith.) media con tools: 98.6 %.
- Costo total 0.0514 USD; el método más caro fue `react_nogate` con 0.0514 USD (100 %).
...
````
report: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_load_split/gpt-4o-mini/react_nogate/report.json   [leído: report.rescored.json]
  scoreboard.json: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_load_split/gpt-4o-mini/react_nogate/scoreboard.json
  scoreboard.csv: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_load_split/gpt-4o-mini/react_nogate/scoreboard.csv
  scoreboard.md: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_load_split/gpt-4o-mini/react_nogate/scoreboard.md
  scoreboard_per_case.json: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_load_split/gpt-4o-mini/react_nogate/scoreboard_per_case.json
  scoreboard.rescored.json: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_load_split/gpt-4o-mini/react_nogate/scoreboard.rescored.json
  scoreboard_per_case.rescored.json: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_load_split/gpt-4o-mini/react_nogate/scoreboard_per_case.rescored.json
  traces (40 archivos): /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_load_split/gpt-4o-mini/react_nogate/traces
````
