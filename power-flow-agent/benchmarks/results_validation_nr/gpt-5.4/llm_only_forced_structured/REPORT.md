...
Generado el 2026-09-16 12:52 por benchmarks/experiment_report.py a partir de 1 report(s) del directorio llm_only_forced_structured (ruta completa en la sección 1). Prosa en español; identificadores (métodos, métricas, campos) en inglés tal como aparecen en los datos.
...
````
/Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_nr/gpt-5.4/llm_only_forced_structured
````
...
- Fecha de la corrida (mtime de report.json): 2026-09-16 12:19
- Costo total: 0.0835 USD (5 items; costo medio 0.01671 USD/item)
- Items totales: 5; ok=5; con error=0; tokens totales=14076
...
|--------------------------------|------|----|-----|--------|-----|----------|----------------|--------|------|----|-----|----|-----|---------|---------|------|
| llm_only_forced:structured | case14 | 5 | -- | 5.19e-03 | 2.41 | 60.0 (3/5) | 100.0 (5/5) | 1.90e+00 | 0.0 | -- | n/a | 2815 | -- | 0.0 (0/5) | 0.0 (0/5) | 0.0835 |
...
| Method | plain | parameterized | multistep | ambiguous |
|--------------------------------|-------------|----------------|---------|---------|
| llm_only_forced:structured | 100.0 (2/2) | 100.0 (1/1) | 0.0 (0/1) | 0.0 (0/1) |
...
--- Scoring ---
formulation=n/a (exact=None); V_MAE=4.20e-04; F_MAE=1.93; faithful=0.0 %; solved=True (numeric_ok); flags=-; error=-; tokens=2814; cost_usd=0.0167; wall=7.3 s
````
...
(sin rondas de herramientas: una sola llamada al LLM)
--- Respuesta final ---
{"converged":true,"bus_voltages":[{"bus_id":1,"vm_pu":1.06,"va_deg":0.0},{"bus_id":2,"vm_pu":1.045,"va_deg":-4.98},{"bus_id":3,"vm_pu":1.01,"va_deg":-12.72},{"bus_id":4,"vm_pu":1.017,"va_deg":-10.33},{"bus_id":5,"vm_pu":1.019,"va_deg":-8.78},{"bus_id":6,"vm_pu":1.07,"va_deg":-14.22},{"bus_id":7,"vm_pu":1.062,"va_deg":-13.37},{"bus_id":8,"vm_pu":1.09,"va_deg":-13.36},{"bus_id":9,"vm_pu":1.056,"va_deg":-14.94},{"bus_id":10,"vm_pu":1.051,"va_deg":-15.1},{"bus_id":11,"vm_pu":1.043,"va_deg":-14.79},{"bus_id":12,"vm_pu":1.055,"va_deg":-15.08},{"bus_id":13,"vm_pu":1.05,"va_deg":-15.16},{"bus_id":14,"vm_pu":1.036,"va_deg":-16.04}],"line_flows":[{"line_id":0,"p_from_mw":156.88,"loading_percent":0.0},{"line_id":1,"p_from_mw":75.51,"loading_percent":0.0},{"line_id":2,"p_from_mw":73.24,"loading_percen …[1048 chars más]
--- Scoring ---
formulation=n/a (exact=None); V_MAE=4.07e-03; F_MAE=2.12; faithful=0.0 %; solved=False (voltage_error); flags=-; error=-; tokens=2808; cost_usd=0.0168; wall=6.8 s
````
...
--- Scoring ---
formulation=n/a (exact=None); V_MAE=2.00e-02; F_MAE=6.06; faithful=0.0 %; solved=False (voltage_error); flags=-; error=-; tokens=2843; cost_usd=0.0168; wall=7.3 s
````
...
- LLM-only: V_MAE entre 5.19e-03 (llm_only_forced:structured/case14) y 5.19e-03 (llm_only_forced:structured/case14) p.u. sobre los items que devolvieron números.
...
- Solved de `llm_only_forced:structured`: 60.0 % (3/5).
...
````
report: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_nr/gpt-5.4/llm_only_forced_structured/report.json   [leído: report.rescored.json]
  scoreboard.json: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_nr/gpt-5.4/llm_only_forced_structured/scoreboard.json
  scoreboard.csv: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_nr/gpt-5.4/llm_only_forced_structured/scoreboard.csv
  scoreboard.md: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_nr/gpt-5.4/llm_only_forced_structured/scoreboard.md
  scoreboard_per_case.json: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_nr/gpt-5.4/llm_only_forced_structured/scoreboard_per_case.json
  scoreboard.rescored.json: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_nr/gpt-5.4/llm_only_forced_structured/scoreboard.rescored.json
  scoreboard_per_case.rescored.json: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_nr/gpt-5.4/llm_only_forced_structured/scoreboard_per_case.rescored.json
  traces (5 archivos): /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_nr/gpt-5.4/llm_only_forced_structured/traces
````
