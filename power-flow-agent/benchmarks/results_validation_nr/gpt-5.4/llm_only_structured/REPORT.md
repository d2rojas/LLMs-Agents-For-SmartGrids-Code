...
Generado el 2026-09-16 12:52 por benchmarks/experiment_report.py a partir de 1 report(s) del directorio llm_only_structured (ruta completa en la sección 1). Prosa en español; identificadores (métodos, métricas, campos) en inglés tal como aparecen en los datos.
...
````
/Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_nr/gpt-5.4/llm_only_structured
````
...
- Fecha de la corrida (mtime de report.json): 2026-09-16 12:18
- Costo total: 0.0398 USD (5 items; costo medio 0.00796 USD/item)
- Items totales: 5; ok=5; con error=0; tokens totales=11052
...
|-----------------------|------|----|-----|--------|-----|----------|----------------|--------|------|----|-----|----|-----|----------|---------|------|
| llm_only:structured | case14 | 5 | -- | 6.16e-04 | 0.88 | 20.0 (1/5) | 20.0 (1/5) | 6.98e-01 | 0.0 | -- | n/a | 2210 | -- | 40.0 (2/5) | 0.0 (0/5) | 0.0398 |
...
| Method | plain | parameterized | multistep | ambiguous |
|-----------------------|----------|----------------|---------|---------|
| llm_only:structured | 50.0 (1/2) | 0.0 (0/1) | 0.0 (0/1) | 0.0 (0/1) |
...
--- Scoring ---
formulation=n/a (exact=None); V_MAE=6.16e-04; F_MAE=0.88; faithful=0.0 %; solved=True (numeric_ok); flags=-; error=-; tokens=2780; cost_usd=0.0166; wall=7.5 s
````
...
--- Scoring ---
formulation=n/a (exact=None); V_MAE=--; F_MAE=--; faithful=0.0 %; solved=False (convergence_mismatch); flags=abstained,abstained_on_solvable; error=-; tokens=2093; cost_usd=0.0058; wall=1.3 s
````
...
(sin rondas de herramientas: una sola llamada al LLM)
--- Respuesta final ---
{"converged":false,"bus_voltages":[],"line_flows":[],"total_generation_mw":0.0,"total_load_mw":253.846783,"total_loss_mw":0.0}
--- Scoring ---
formulation=n/a (exact=None); V_MAE=--; F_MAE=--; faithful=0.0 %; solved=False (convergence_mismatch); flags=-; error=-; tokens=2053; cost_usd=0.0058; wall=1.3 s
````
...
- LLM-only: V_MAE entre 6.16e-04 (llm_only:structured/case14) y 6.16e-04 (llm_only:structured/case14) p.u. sobre los items que devolvieron números.
- 40.0 % (2/5) de abstención en LLM-only (respuesta con `converged=false` o arrays vacíos).
- En LLM-only, 4 items no resueltos por `convergence_mismatch` y 0 por `voltage_error`.
- Ningún item terminó con `error`.
- Solved de `llm_only:structured`: 20.0 % (1/5).
...
- Costo total 0.0398 USD; el método más caro fue `llm_only:structured` con 0.0398 USD (100 %).
...
````
report: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_nr/gpt-5.4/llm_only_structured/report.json   [leído: report.rescored.json]
  scoreboard.json: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_nr/gpt-5.4/llm_only_structured/scoreboard.json
  scoreboard.csv: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_nr/gpt-5.4/llm_only_structured/scoreboard.csv
  scoreboard.md: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_nr/gpt-5.4/llm_only_structured/scoreboard.md
  scoreboard_per_case.json: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_nr/gpt-5.4/llm_only_structured/scoreboard_per_case.json
  scoreboard.rescored.json: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_nr/gpt-5.4/llm_only_structured/scoreboard.rescored.json
  scoreboard_per_case.rescored.json: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_nr/gpt-5.4/llm_only_structured/scoreboard_per_case.rescored.json
  traces (5 archivos): /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_nr/gpt-5.4/llm_only_structured/traces
````
