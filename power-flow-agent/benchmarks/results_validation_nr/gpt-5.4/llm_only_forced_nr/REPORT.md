...
````
/Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_nr/gpt-5.4/llm_only_forced_nr
````
...
- Fecha de la corrida (mtime de report.json): 2026-09-16 12:21
- Costo total: 0.1063 USD (5 items; costo medio 0.02127 USD/item)
- Items totales: 5; ok=5; con error=0; tokens totales=17105
...
|----------------------|------|----|-----|--------|-----|----------|----------------|--------|------|----|-----|----|-----|---------|---------|------|
| llm_only_forced:nr | case14 | 5 | -- | 1.06e-02 | 2.56 | 60.0 (3/5) | 100.0 (5/5) | 2.04e+00 | 0.0 | -- | n/a | 3421 | -- | 0.0 (0/5) | 0.0 (0/5) | 0.1063 |
...
| Method | plain | parameterized | multistep | ambiguous |
|----------------------|-------------|----------------|---------|---------|
| llm_only_forced:nr | 100.0 (2/2) | 100.0 (1/1) | 0.0 (0/1) | 0.0 (0/1) |
...
```json
{
  ...
  "line_f …[1408 chars más]
--- Scoring ---
formulation=n/a (exact=None); V_MAE=4.20e-04; F_MAE=1.56; faithful=0.0 %; solved=True (numeric_ok); flags=-; error=-; tokens=3421; cost_usd=0.0213; wall=7.8 s
````
...
```json
{
  ...
  "bus_voltages": [
    {"bus_id": 1, "vm_pu": 1.06, "va_deg": 0.0},
    {"bus_id": 2, "vm_pu": 1.045, "va_deg": -4.98},
    {"bus_id": 3, "vm_pu": 1.01, "va_deg": -12.73},
    {"bus_id": 4, "vm_pu": 1.001, "va_deg": -10.31},
    {"bus_id": 5, "vm_pu": 1.008, "va_deg": -8.77},
    {"bus_id": 6, "vm_pu": 1.07, "va_deg": -14.22},
    {"bus_id": 7, "vm_pu": 1.002, "va_deg": -13.37},
    {"bus_id": 8, "vm_pu": 1.09, "va_deg": -13.37},
    {"bus_id": 9, "vm_pu": 0.984, "va_deg": -14.94},
    {"bus_id": 10, "vm_pu": 0.979, "va_deg": -15.26},
    {"bus_id": 11, "vm_pu": 1.048, "va_deg": -14.22},
    {"bus_id": 12, "vm_pu": 1.036, "va_deg": -15.08},
    {"bus_id": 13, "vm_pu": 1.028, "va_deg": -15.27},
    {"bus_id": 14, "vm_pu": 0.963, "va_deg": -16.05}
  ],
  "line …[1415 chars más]
--- Scoring ---
formulation=n/a (exact=None); V_MAE=2.32e-02; F_MAE=2.52; faithful=0.0 %; solved=False (voltage_error); flags=-; error=-; tokens=3409; cost_usd=0.0212; wall=7.4 s
````
...
```json
{
  ...
  "bus_voltages": [
    {"bus_id": 1, "vm_pu": 1.06, "va_deg": 0.0},
    {"bus_id": 2, "vm_pu": 1.045, "va_deg": -5.01},
    {"bus_id": 3, "vm_pu": 1.01, "va_deg": -12.23},
    {"bus_id": 4, "vm_pu": 1.008, "va_deg": -10.31},
    {"bus_id": 5, "vm_pu": 1.012, "va_deg": -8.77},
    {"bus_id": 6, "vm_pu": 1.07, "va_deg": -14.13},
    {"bus_id": 7, "vm_pu": 1.001, "va_deg": -13.62},
    {"bus_id": 8, "vm_pu": 1.09, "va_deg": -13.62},
    {"bus_id": 9, "vm_pu": 0.976, "va_deg": -14.72},
    {"bus_id": 10, "vm_pu": 0.969, "va_deg": -15.34},
    {"bus_id": 11, "vm_pu": 1.017, "va_deg": -14.40},
    {"bus_id": 12, "vm_pu": 1.025, "va_deg": -14.92},
    {"bus_id": 13, "vm_pu": 1.051, "va_deg": -15.18},
    {"bus_id": 14, "vm_pu": 0.950, "va_deg": -16.42}
  ],
  "line …[1413 chars más]
--- Scoring ---
formulation=n/a (exact=None); V_MAE=2.78e-02; F_MAE=6.77; faithful=0.0 %; solved=False (voltage_error); flags=-; error=-; tokens=3450; cost_usd=0.0214; wall=7.4 s
````
...
- LLM-only: V_MAE entre 1.06e-02 (llm_only_forced:nr/case14) y 1.06e-02 (llm_only_forced:nr/case14) p.u. sobre los items que devolvieron números.
- 0.0 % (0/5) de abstención en LLM-only (respuesta con `converged=false` o arrays vacíos).
- En LLM-only, 0 items no resueltos por `convergence_mismatch` y 2 por `voltage_error`.
- Ningún item terminó con `error`.
- Solved de `llm_only_forced:nr`: 60.0 % (3/5).
- Ningún item reclamó éxito sobre un fallo (claimed_success_on_failure=0).
- Trazabilidad de números (Faith.) media en LLM-only: 0.0 % (sin tools, todo número es no trazable salvo los copiados de la request).
- Costo total 0.1063 USD; el método más caro fue `llm_only_forced:nr` con 0.1063 USD (100 %).
...
````
report: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_nr/gpt-5.4/llm_only_forced_nr/report.json   [leído: report.rescored.json]
  scoreboard.json: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_nr/gpt-5.4/llm_only_forced_nr/scoreboard.json
  scoreboard.csv: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_nr/gpt-5.4/llm_only_forced_nr/scoreboard.csv
  scoreboard.md: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_nr/gpt-5.4/llm_only_forced_nr/scoreboard.md
  scoreboard_per_case.json: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_nr/gpt-5.4/llm_only_forced_nr/scoreboard_per_case.json
  scoreboard.rescored.json: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_nr/gpt-5.4/llm_only_forced_nr/scoreboard.rescored.json
  scoreboard_per_case.rescored.json: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_nr/gpt-5.4/llm_only_forced_nr/scoreboard_per_case.rescored.json
  traces (5 archivos): /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_nr/gpt-5.4/llm_only_forced_nr/traces
````
