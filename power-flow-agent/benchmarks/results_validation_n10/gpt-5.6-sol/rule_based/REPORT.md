...
Generado el 2026-09-18 22:00 por benchmarks/experiment_report.py a partir de 1 report(s) del directorio rule_based (ruta completa en la sección 1). Prosa en español; identificadores (métodos, métricas, campos) en inglés tal como aparecen en los datos.
...
````
/Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_n10/gpt-5.6-sol/rule_based
````
...
- Fecha de la corrida (mtime de report.json): 2026-09-18 04:53
- Costo total: 0.0000 USD (10 items; costo medio 0.00000 USD/item)
- Items totales: 10; ok=7; con error=3; tokens totales=0
...
|-----------------------|-----|---------------------|
| formulation_failure | 3 | rule_based (3) |
...
|----------|------|----|-------------|-----|-----|-------------|----------------|------|----------------|----|-----|----|-----|-------------|-----------------|------|
| rule_based | case14 | 10 | 70.0 (7/10) | 0 | 0.00 | 70.0 (7/10) | 100.0 (7/7) | 0 | 100.0 (10/10) | -- | 1.9 | n/a | -- | 30.0 (3/10) | 0.0 (0/10) | 0.0000 |

### Formulación exacta por dificultad (items con etapa de tools; `n/a` = sin tools)

| Method | plain | parameterized | multistep | ambiguous |
|----------|----------|----------------|-------------|-------------|
| rule_based | 66.7 (2/3) | 33.3 (1/3) | 100.0 (2/2) | 100.0 (2/2) |
...
````
request (case14-parameterized-009-s0, case14, difficulty=parameterized, seed=1043521779): Load the 14-bus test case (case14) and run an N-1 contingency analysis ranked by max violations and report the 3 worst outages.
...
- El gate verificó 12 resultados de flujo, 0 fallaron la verificación y se activó (retuvo números) 0 veces en 0 items.
- 3 items con `formulation_failure`: el método no formuló ninguna tool call.
- Solved de `rule_based`: 70.0 % (7/10).
- Formulación exacta agregada sobre métodos con tools: 70.0 % (7/10).
- Formulación por dificultad: mejor `multistep` 100.0 % (2/2), peor `parameterized` 33.3 % (1/3).
- Errores de formulación más frecuentes: `unparsed`=3.
...
- Métodos con tools: 1.90 tool calls medias por item (máximo 5).
...
````
report: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_n10/gpt-5.6-sol/rule_based/report.json
  scoreboard.json: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_n10/gpt-5.6-sol/rule_based/scoreboard.json
  scoreboard.csv: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_n10/gpt-5.6-sol/rule_based/scoreboard.csv
  scoreboard.md: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_n10/gpt-5.6-sol/rule_based/scoreboard.md
  scoreboard_per_case.json: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_n10/gpt-5.6-sol/rule_based/scoreboard_per_case.json
  traces (10 archivos): /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_n10/gpt-5.6-sol/rule_based/traces
````
