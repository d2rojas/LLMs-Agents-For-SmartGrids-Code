...
Generado el 2026-09-18 21:58 por benchmarks/experiment_report.py a partir de 1 report(s) del directorio llm_only_structured (ruta completa en la sección 1). Prosa en español; identificadores (métodos, métricas, campos) en inglés tal como aparecen en los datos.
...
````
/Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_n10/gpt-5.6-sol/llm_only_structured
````
...
- System prompt: hash `1b4712c641b5` (10 filas)
- runs por item: 1; k (perturbación ±10 %·k): 1; seeds: [0]; max_rounds: 8; temperature: 0.0; timeout_s: 90.0
- Fecha de la corrida (mtime de report.json): 2026-09-18 00:56
- Costo total: 0.9082 USD (10 items; costo medio 0.09082 USD/item)
- Items totales: 10; ok=10; con error=0; tokens totales=106978
- Solved global: 50.0 % (5/10)
...
|-----------------------|------|----|-----|--------|-----|-------------|----------------|--------|----------|----|-----|-----|-----|----------|-----------------|------|
| llm_only:structured | case14 | 10 | -- | 1.68e-03 | 0.48 | 50.0 (5/10) | 80.0 (8/10) | 1.41e-01 | 0.0 (0/10) | -- | n/a | 10698 | -- | 0.0 (0/10) | 50.0 (5/10) | 0.9082 |
...
| Method | plain | parameterized | multistep | ambiguous |
|-----------------------|----------|----------------|-------------|---------|
| llm_only:structured | 66.7 (2/3) | 33.3 (1/3) | 100.0 (2/2) | 0.0 (0/2) |
...
--- Respuesta final ---
{"converged":true,"bus_voltages":[{"bus_id":1,"vm_pu":1.06,"va_deg":0.0},{"bus_id":2,"vm_pu":1.045,"va_deg":-5.1},{"bus_id":3,"vm_pu":1.01,"va_deg":-12.95},{"bus_id":4,"vm_pu":1.0145,"va_deg":-10.65},{"bus_id":5,"vm_pu":1.0172,"va_deg":-8.95},{"bus_id":6,"vm_pu":1.07,"va_deg":-13.32},{"bus_id":7,"vm_pu":1.0505,"va_deg":-14.55},{"bus_id":8,"vm_pu":1.09,"va_deg":-14.55},{"bus_id":9,"vm_pu":1.033,"va_deg":-16.61},{"bus_id":10,"vm_pu":1.031,"va_deg":-16.32},{"bus_id":11,"vm_pu":1.0458,"va_deg":-14.97},{"bus_id":12,"vm_pu":1.0598,"va_deg":-13.96},{"bus_id":13,"vm_pu":0.9178,"va_deg":-22.44},{"bus_id":14,"vm_pu":0.9623,"va_deg":-20.19}],"line_flows":[{"line_id":0,"p_from_mw":159.3,"loading_percent":0.0},{"line_id":1,"p_from_mw":77.52,"loading_percent":0.0},{"line_id":2,"p_from_mw":69.8,"loading_ …[1041 chars más]
--- Scoring ---
formulation=n/a (exact=None); V_MAE=2.91e-04; F_MAE=0.65; faithful=0.0 %; solved=True (numeric_ok); flags=-; error=-; tokens=17996; cost_usd=0.1636; wall=357.3 s
````
...
(sin rondas de herramientas: una sola llamada al LLM)
--- Respuesta final ---
{"converged":true,"bus_voltages":[{"bus_id":1,"vm_pu":1.06,"va_deg":0.0},{"bus_id":2,"vm_pu":1.045,"va_deg":-5.0},{"bus_id":3,"vm_pu":1.01,"va_deg":-12.34},{"bus_id":4,"vm_pu":1.0188,"va_deg":-10.43},{"bus_id":5,"vm_pu":1.0205,"va_deg":-8.91},{"bus_id":6,"vm_pu":1.07,"va_deg":-14.35},{"bus_id":7,"vm_pu":1.061,"va_deg":-13.87},{"bus_id":8,"vm_pu":1.09,"va_deg":-13.87},{"bus_id":9,"vm_pu":1.0525,"va_deg":-15.43},{"bus_id":10,"vm_pu":1.0445,"va_deg":-15.86},{"bus_id":11,"vm_pu":1.0635,"va_deg":-14.69},{"bus_id":12,"vm_pu":1.0535,"va_deg":-15.43},{"bus_id":13,"vm_pu":1.0475,"va_deg":-15.63},{"bus_id":14,"vm_pu":1.0325,"va_deg":-16.88}],"line_flows":[{"line_id":0,"p_from_mw":151.9,"loading_percent":0.0},{"line_id":1,"p_from_mw":73.4,"loading_percent":0.0},{"line_id":2,"p_from_mw":67.8,"loading_ …[1029 chars más]
--- Scoring ---
formulation=n/a (exact=None); V_MAE=1.55e-03; F_MAE=0.63; faithful=0.0 %; solved=False (voltage_error); flags=-; error=-; tokens=11856; cost_usd=0.1025; wall=195.9 s
````
...
(sin rondas de herramientas: una sola llamada al LLM)
--- Respuesta final ---
{"converged":true,"bus_voltages":[{"bus_id":1,"vm_pu":1.06,"va_deg":0.0},{"bus_id":2,"vm_pu":1.045,"va_deg":-5.05},{"bus_id":3,"vm_pu":1.01,"va_deg":-13.0},{"bus_id":4,"vm_pu":1.014,"va_deg":-10.55},{"bus_id":5,"vm_pu":1.018,"va_deg":-8.95},{"bus_id":6,"vm_pu":1.07,"va_deg":-14.35},{"bus_id":7,"vm_pu":1.062,"va_deg":-13.95},{"bus_id":8,"vm_pu":1.09,"va_deg":-13.95},{"bus_id":9,"vm_pu":1.052,"va_deg":-15.75},{"bus_id":10,"vm_pu":1.048,"va_deg":-15.9},{"bus_id":11,"vm_pu":1.057,"va_deg":-15.35},{"bus_id":12,"vm_pu":1.05,"va_deg":-16.8},{"bus_id":13,"vm_pu":1.03,"va_deg":-18.05},{"bus_id":14,"vm_pu":1.031,"va_deg":-17.85}],"line_flows":[{"line_id":0,"p_from_mw":157.5,"loading_percent":0.0},{"line_id":1,"p_from_mw":75.0,"loading_percent":0.0},{"line_id":2,"p_from_mw":73.0,"loading_percent":0.0 …[1015 chars más]
--- Scoring ---
formulation=n/a (exact=None); V_MAE=6.43e-03; F_MAE=0.83; faithful=0.0 %; solved=False (voltage_error); flags=-; error=-; tokens=11801; cost_usd=0.1019; wall=191.3 s
````
...
- LLM-only: V_MAE entre 1.68e-03 (llm_only:structured/case14) y 1.68e-03 (llm_only:structured/case14) p.u. sobre los items que devolvieron números.
- 0.0 % (0/10) de abstención en LLM-only (respuesta con `converged=false` o arrays vacíos).
- En LLM-only, 2 items no resueltos por `convergence_mismatch` y 3 por `voltage_error`.
- Ningún item terminó con `error`.
- Solved de `llm_only:structured`: 50.0 % (5/10).
- Ningún item reclamó éxito sobre un fallo (claimed_success_on_failure=0).
- Trazabilidad de números (Faith.) media en LLM-only: 0.1 % (sin tools, todo número es no trazable salvo los copiados de la request).
- Costo total 0.9082 USD; el método más caro fue `llm_only:structured` con 0.9082 USD (100 %).
...
````
report: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_n10/gpt-5.6-sol/llm_only_structured/report.json
  scoreboard.json: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_n10/gpt-5.6-sol/llm_only_structured/scoreboard.json
  scoreboard.csv: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_n10/gpt-5.6-sol/llm_only_structured/scoreboard.csv
  scoreboard.md: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_n10/gpt-5.6-sol/llm_only_structured/scoreboard.md
  scoreboard_per_case.json: /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_n10/gpt-5.6-sol/llm_only_structured/scoreboard_per_case.json
  traces (10 archivos): /Users/lzanda/Documents/REVIEW-TUTORIAL-LLMS-AND-AGENTIC-FOR-SMART-GRIDS/03-codigo-casos-estudio/LLMs-Agents-For-SmartGrids-Code-v2/power-flow-agent/benchmarks/results_validation_n10/gpt-5.6-sol/llm_only_structured/traces
````
